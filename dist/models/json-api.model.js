...
var JsonApiModel = /** @class */ (function () {
    ...
    JsonApiModel.prototype.parseHasOne = function (data, included, level) {
        ...
        if (hasOne) {
            for (var _i = 0, hasOne_1 = hasOne; _i < hasOne_1.length; _i++) {
                ...
                var relationship = data.relationships
                ...
                if (relationship &&
                    ...
                    if (!includes_1.default(modelTypesFetched, typeName)) {
                        ...
                        if (modelType) {
                            ...
                            throw {
                                message: 'parseHasOne - Model type for relationship ' +
                                    typeName +
                                    ' not found.'
                            };
                        }
                    ...
                    for (var _a = 0, _b = Object.keys(relationship.data); _a < _b.length; _a++) {
                        ...
                        if (!includes_1.default(modelTypesFetched, typeName)) {
                            ...
                            if (modelType) {
                                ...
                                throw {
                                    message: 'parseHasMany - Model type for relationship ' +
                                        typeName +
                                        ' not found.'
                                };
                            }
        ...
        if (belongsTo) {
            for (var _i = 0, belongsTo_1 = belongsTo; _i < belongsTo_1.length; _i++) {
                ...
                if (relationship && relationship.data) {
                    var dataRelationship = relationship.data instanceof Array
                        ? relationship.data[0]
                        : relationship.data;
                    if (dataRelationship) {
                        ...
                        if (modelType) {
                            ...
                            throw {
                                message: 'parseBelongsTo - Model type for relationship ' +
                                    typeName +
                                    ' not found.'
                            };
                        }
    ...
    JsonApiModel.prototype.getHasManyRelationship = function (modelType, data, included, typeName, level) {
        ...
        data.forEach(function (item) {
            var relationshipData = find_1.default(included, {
                id: item.id,
                type: typeName
            });
            if (relationshipData) {
